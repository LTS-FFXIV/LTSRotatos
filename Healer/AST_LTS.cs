...
public sealed class AST_LTS : AST_Base
{
    ...
    public override string RotationName => "LTS AST";
    ...
    protected override IRotationConfigSet CreateConfiguration()
        ...
        .SetCombo(CombatType.PvE, SpeedLightUsage, 0, "The Strategy to use Speedlight", "In Burst", "When Moving", "When cool down");
